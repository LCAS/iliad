...
def tracked_persons_callback(trackedPersons_map_frame):
    ...
    trackedPersons_robot_frame.header.frame_id = "robot3/base_footprint"
    ...
    for track in trackedPersons_map_frame.tracks:
        ...
        tmp_pose_msg.header.frame_id = "map_laser2d"
        tmp_pose_msg.pose = track.pose.pose
        tmp_pose_msg_robot_frame = tf_listener.transformPose("robot3/base_footprint",tmp_pose_msg)  
        ...
        tmp_vector3_msg.header.frame_id = "map_laser2d"
        tmp_vector3_msg.vector = track.twist.twist.linear
        tmp_vector3_msg_linear = tf_listener.transformVector3("robot3/base_footprint",tmp_vector3_msg)
...
tf_listener.waitForTransform("robot3/base_footprint","map_laser2d",rospy.Time(),rospy.Duration(20))

track_robot_frame_publisher = rospy.Publisher("robot3/human_perception/tracked_persons_in_base_link", TrackedPersons, queue_size=1)
track_map_frame_subscriber = rospy.Subscriber("robot3/human_perception/tracked_persons_in_map_frame", TrackedPersons, tracked_persons_callback, queue_size=1)
