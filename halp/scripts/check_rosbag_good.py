...
bagURI = '/home/manolofc/workspace/iliad_ws/reactive_nav_orig.bag'
...
# what mpc covered
print("Executed")
(x_exec, y_exec, tetha_exec, phi_exec,cn_exec, sn_exec, st_exec) = parse_report_from_rosbag('/robot4/control/controller/reports',bag)
# last good point
...
# what we send to mpc
print("to MPC")
(x_mpc, y_mpc,tetha_mpc,phi_mpc,v_mpc,w_mpc,cn_mpc, sn_mpc) = parse_trajectory_from_rosbag('/robot4/control/controller/trajectories', bag)
...
if showPoses:
    ...
    plt.plot(x_mpc[0:last_index],y_mpc[0:last_index],'.', label='ORU trajectory')
