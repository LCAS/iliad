...
{    
  ...
  ROS_DEBUG("[tw_controller_node@%d] vel command received (%2.2f, %2.2f)", __LINE__,v,rot);
...
int main(int argc, char** argv)
{
  ...
  ROS_DEBUG("[tw_controller_node@%d] ROS subscriber created ", __LINE__);
  ...
  ROS_DEBUG("[tw_controller_node@%d] CAN command sender created ", __LINE__);
